...
for org in organizations:
    ...
    with open(csvname, 'w', encoding='utf-8', newline='') as f:
        csvheader = ['Network', 'AP', 'SSID_Name', 'SSID_Band', 'SSID_Channel', 'SSID_ChannelWidth', 'BSSID']
        writer = csv.writer(f)
        ...
        for i in devices_aps:
            ...
            for item in bssid_info:
                data = [network_info['name'], i['name'], item['ssidName'], item['band'], item['channel'], item['channelWidth'], item['bssid']]
